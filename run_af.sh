...
DATA_ROOT_PROCESSED="./data/aigs_pyg"    # Root dir containing the 'aig' folder
...
# Use similar base hyperparameters, adjust if needed for GraphAF stability/performance
LR=0.0005
WEIGHT_DECAY=1e-5
BATCH_SIZE=64
MAX_EPOCHS=50             # Adjust epochs if needed for GraphAF convergence
...
# *** GraphAF typically uses a single temperature ***
TEMPERATURE_AF=0.75       # Generation temperature for GraphAF prior sampling
...
echo " - Temperature: ${TEMPERATURE_AF}" # Single temperature for GraphAF
echo " - Min Nodes: ${MIN_NODES}"
echo " - Output File: ${GEN_PICKLE_PATH}"
echo "----------------------------------------"

# Execute the generation script
# *** Use --temperature_af for GraphAF ***
