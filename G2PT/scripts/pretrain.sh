#!/bin/bash
#SBATCH --job-name=g2pt_base2
#SBATCH --partition=gpu_h100     # Specify the appropriate partition here
#SBATCH --gpus=1
#SBATCH --time=08:00:00
#SBATCH --output=../slurm_logs/g2pt_base2_%j.out
...
mkdir -p slurm_logs
mkdir -p results/aig-base2-topo # Ensure output dir exists
...
srun python -u train.py configs/datasets/aig.py configs/networks/base.py \
    --dataset=aig \
    --ordering=topo \
    --out_dir=results/aig-base2-topo \
    --wandb_log=True
