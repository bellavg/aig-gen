...
MODEL_OUT_DIR="results/aig-base-topo-3"
mkdir -p slurm_logs
...
srun python -u sample.py \
    ...
    --batch_size 256 \
    --seed 1337 \
    --output_filename generated_base_topo_3_temp0.8_aigs.pkl # Optional: give specific name

echo "--- Sampling Finished ---"

echo "--- Starting Evaluation Script ---"
# Define the path to the generated pickle file
GENERATED_PICKLE_PATH="$MODEL_OUT_DIR/generated_base_topo_3_temp0.8_aigs.pkl"
