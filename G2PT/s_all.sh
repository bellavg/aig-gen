...
# --- Configuration ---
MODEL_CHECKPOINT_PATH="results/aig-base-topo-aug5/bestest.pt"
TOKENIZER_PATH="datasets/aig/tokenizer"
BASE_OUTPUT_DIR="sampling_outputs" # Consider a new output dir for 1k experiments
NUM_SAMPLES=1000
MAX_NEW_TOKENS=768
# --- End Configuration ---
...
srun python -u beam_search_sample.py \
    ...
    --search_type normal \
    --beam_size 1000 \    # Explicitly set, aligns with Python's internal override
...
srun python -u beam_search_sample.py \
    ...
    --tokenizer_path $TOKENIZER_PATH \
    --search_type normal \
    --beam_size 1000 \   # Set to 1000 for clarity, aligns with Python override
    --num_beam_groups 20 \   # Example: 20 groups, ensure 1000 % 20 == 0
